...
Dopo aver fatto ciò, puoi tranquillamente avviare il software (es. `python3 PC_Miner.py`).
...
<details>
  ...
  ### Nota che le ricompense dipendono da tanti fattori, e la tabella sotto è solo a scopo orientativo.
  
  | Dispositivo/CPU/SBC/MCU/chip                                   | Hashrate medio<br>(tutti i thread) | Thread<br>di mining | Assorbimento<br>energetico | Media di<br>DUCO/giorno |
  |-----------------------------------------------------------|-----------------------------------|-------------------|----------------|---------------------|
  | Arduino Pro Mini, Uno, Nano etc.<br>(Atmega 328p/pb/16u2) | 196 H/s                           | 1                 | 0.2 W          | 9-10                |
  | Teensy 4.1 (crittografia software)                            | 80 kH/s                           | 1                 | 0.5 W          | -                   |
  ...
  Tutti i test sono stati svolti con l'algoritmo DUCO-S1. Questa tabella verrà attivamente aggiornata.
</details>
...
<details>
  ...
  Per favore, tieni a mente che questi software non sono sviluppati da noi e non diamo alcuna garanzia che usarli non comporterà un ban dell'account. Trattali come una curiosità. È giusto ricordare che usare [nonceMiner](https://github.com/colonelwatch/nonceMiner) di colonelwatch **ti garantirà un ban dell'account**.

  ### Altri miner che funzionano con Duino-Coin:
  ...
  *   [MineCryptoOnWifiRouter](https://github.com/BastelPichi/MineCryptoOnWifiRouter) - script Python per minare  Duino-Coin sui router, di BastelPichi
  *   [Duino-Coin_Android_Cluster Miner](https://github.com/DoctorEenot/DuinoCoin_android_cluster) - mina con meno connessioni su più dispositivi Android, di DoctorEenot
  *   [ESPython DUCO Miner](https://github.com/fabiopolancoe/ESPython-DUCO-Miner) - miner in MicroPython per schede ESP, di fabiopolancoe
  *   [DUCO Miner for Nintendo 3DS](https://github.com/BunkerInnovations/duco-3ds) - miner in Python per Nintendo 3DS, di PhereloHD & HGEpro
  *   [Dockerized DUCO Miner](https://github.com/Alicia426/Dockerized_DUCO_Miner_minimal) - miner per Docker, di Alicia426
  *   [NodeJS-DuinoCoin-Miner](https://github.com/DarkThinking/NodeJS-DuinoCoin-Miner/) - miner in NodeJS, di DarkThinking
  *   [d-cpuminer](https://github.com/phantom32-0/d-cpuminer) - miner in C puro, di phantom32 e revoxhere
  *   [Go Miner](https://github.com/yippiez/go-miner) di yippiez
  *   [ducominer](https://github.com/its5Q/ducominer) di its5Q
  *   [Unofficial miners directory](https://github.com/revoxhere/duino-coin/tree/master/Unofficial%20miners)
      *   [Julia Miner](https://github.com/revoxhere/duino-coin/blob/master/Unofficial%20miners/Julia_Miner.jl) di revoxhere
      *   [Ruby Miner](https://github.com/revoxhere/duino-coin/blob/master/Unofficial%20miners/Ruby_Miner.rb) di revoxhere
      *   [Minimal Python Miner (DUCO-S1)](https://github.com/revoxhere/duino-coin/blob/master/Unofficial%20miners/Minimal_PC_Miner.py) di revoxhere
      *   [Teensy 4.1 code for Arduino IDE](https://github.com/revoxhere/duino-coin/blob/master/Unofficial%20miners/Teensy_code/Teensy_code.ino) di joaquinbvw

  ### Altri strumenti:
  *   [Duino Miner](https://github.com/g7ltt/Duino-Miner) - files e documentazione per il miner DUCO basato su Arduino Nano, di g7ltt
  *   [DUINO Mining Rig](https://repalmakershop.com/pages/duino-mining-rig) - files 3D, disegni PCB, e istruzioni per creare il tuo Duino rig, di ReP_AL
  *   [DuinoCoin-balance-Home-Assistant](https://github.com/NL647/DuinoCoin-balance-Home-Assistant) - addon per Home Assistant che mostra il tuo bilancio, di NL647
  *   [Duino Coin Status Monitor](https://github.com/TSltd/duino_coin) per il display 128x64 SSD1306 OLED ed ESP8266, di TSltd
  *   [ducopanel](https://github.com/ponsato/ducopanel) - una app GUI per controllare i tuoi miners Duino-Coin, di ponsato
  *   [Duino AVR Monitor](https://www.microsoft.com/store/apps/9NJ7HPFSR9V5) - app GUI Windows per monitorare  miners AVR, di niknak
  *   [Duino-Coin Arduino library](https://github.com/ricaun/arduino-DuinoCoin), di ricaun
  *   [DuinoCoinI2C](https://github.com/ricaun/DuinoCoinI2C) - usa ESP8266/ESP32 come master per Arduino, di ricaun
  *   [Duino-Coin Mining Dashboard](https://lulaschkas.github.io/duco-mining-dashboard/) dashboard mining e risoluzione dei problemi, di Lulaschkas
  *   [duco-miners](https://github.com/dansinclair25/duco-miners) dashboard mining CLI, di dansinclair25
  *   [Duco-Coin Symbol Icon ttf](https://github.com/SandUhrGucker/Duco-Coin-Symbol-Icon-ttf-.h), di SandUhrGucker
  *   [DUCO Browser Extension](https://github.com/LDarki/DucoExtension) per Chromium e derivati, di LDarki
  *   [DUCO Monitor](https://siunus.github.io/duco-monitor/) sito di statistiche account, di siunus
  *   [duino-tools](https://github.com/kyngs/duino-tools) scritti in Java, di kyngs
  *   [Duino Stats](https://github.com/Bilaboz/duino-stats) bot Discord ufficiale, di Bilaboz
  *   [DuCoWallet](https://github.com/viktor02/DuCoWallet) portafoglio GUI, di viktor02
  *   [Duco-widget-ios](https://github.com/naphob/duco-widget-ios) - un widget Duino-Coin per iOS, di Naphob 

  Puoi trovare una lista simile anche sul [sito web](https://duinocoin.com/apps).
</details>
