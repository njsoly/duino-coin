...
<details>
  ...
  ### Penambang lain yang diketahui bekerja dengan Duino-Coin:
  * [DuinoCoinbyLabVIEW](https://github.com/ericddm/DuinoCoinbyLabVIEW) - penambang untuk keluarga LabVIEW oleh ericddm
  * [Duino-JS](https://github.com/Hoiboy19/Duino-JS) - penambang JavaScript yang dapat Anda terapkan dengan mudah di situs Anda oleh Hoiboy19
  * [Mineuino](https://github.com/VatsaDev/Mineuino) - monetizer situs web oleh VatsaDev
  * [Repositori terkait duco hauchel](https://github.com/hauchel/duco/) - Kumpulan berbagai kode untuk menambang DUCO di mikrokontroler lain
  * [duino-coin-php-miner](https://github.com/ricardofiorani/duino-coin-php-miner) Dockerized Miner di PHP oleh ricardofiorani
  * [duino-coin-kodi](https://github.com/SandUhrGucker/duino-coin-kodi) - Addon penambangan untuk Kodi Media Center oleh SandUhrGucker
  * [MineCryptoOnWifiRouter](https://github.com/BastelPichi/MineCryptoOnWifiRouter) - Skrip Python untuk menambang Duino-Coin di router oleh BastelPichi
  *   [Duino-Coin_Android_Cluster Miner](https://github.com/DoctorEenot/DuinoCoin_android_cluster) - menambang dengan lebih sedikit koneksi di beberapa perangkat oleh DoctorEenot
  ...
  *   [ Direktori penambangan Unofficial](https://github.com/revoxhere/duino-coin/tree/master/Unofficial%20miners)
      ...
      *   [Teensy 4.1 untuk Arduino IDE](https://github.com/revoxhere/duino-coin/blob/master/Unofficial%20miners/Teensy_code/Teensy_code.ino) by joaquinbvw

  ### Alat lainnya:
  * [DuinoCoin-balance-Home-Assistant](https://github.com/NL647/DuinoCoin-balance-Home-Assistant) - addon untuk asisten rumah yang menampilkan saldo Anda dengan NL647
  * [Monitor Status Duino Coin](https://github.com/TSltd/duino_coin) untuk 128x64 SSD1306 OLED dan ESP8266 oleh TSltd
  * [ducopanel](https://github.com/ponsato/ducopanel) - aplikasi GUI untuk mengontrol penambang Duino-Coin Anda dengan ponsato
  * [Monitor AVR Duino](https://www.microsoft.com/store/apps/9NJ7HPFSR9V5) - Aplikasi Windows GUI untuk memantau perangkat AVR yang menambang DUCO oleh niknak
  * [Perpustakaan Arduino Duino-Coin](https://github.com/ricaun/arduino-DuinoCoin) oleh ricaun
  * [DuinoCoinI2C](https://github.com/ricaun/DuinoCoinI2C) - Gunakan ESP8266/ESP32 sebagai master untuk Arduino oleh ricaun
  * [Dasbor Penambangan Duino-Coin](https://lulaschkas.github.io/duco-mining-dashboard/) dan bantuan pemecahan masalah oleh Lulaschkas
  * [duco-miners](https://github.com/dansinclair25/duco-miners) Dasbor penambangan CLI dibuat oleh dansinclair25
  * [Ikon Simbol Duco-Coin ttf](https://github.com/SandUhrGucker/Duco-Coin-Symbol-Icon-ttf-.h) oleh SandUhrGucker
  * [Ekstensi Browser DUCO](https://github.com/LDarki/DucoExtension) untuk Chrome dan turunannya oleh LDarki
  * [DUCO Monitor](https://siunus.github.io/duco-monitor/) situs statistik akun oleh siunus
  * [duino-tools](https://github.com/kyngs/duino-tools) ditulis dalam Java oleh kyngs
  * [Duino Stats](https://github.com/Bilaboz/duino-stats) bot Discord resmi oleh Bilaboz
  * [DuCoWallet](https://github.com/viktor02/DuCoWallet) GUI Wallet oleh viktor02

  Daftar ini akan diperbarui secara aktif. Jika Anda ingin menambahkan perangkat lunak ke daftar ini, kirimkan PR atau hubungi salah satu pengembang.
  Anda juga dapat melihat daftar serupa di [situs web](https://duinocoin.com/apps).
</details>
...
<details>
  ...
  ### Harap diperhatikan bahwa saat ini hadiah sedang diubah menjadi logaritmik dan tabelnya tidak akurat.
  
  | Perangkat/CPU/SBC/MCU/chip                                   | Rata-rata hashrate<br>(semua threads) | Mining<br>threads | Penggunaan<br>daya | Rata-rata<br>DUCO/hari |
  |-----------------------------------------------------------|-----------------------------------|-------------------|----------------|---------------------|
  ...
  Semua pengujian dilakukan dengan menggunakan algoritma DUCO-S1. Tabel ini akan diperbarui secara aktif.
</details>
